...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 z-[1] pointer-events-none opacity-30 md:opacity-100"
      >
        <canvas
          ref={canvasRef}
      ...
      <motion.div
        className="absolute top-[65%] md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none z-10 flex flex-col items-center justify-center"
      ...
      >
        <motion.div
          ...
          className="opacity-[0.06] md:opacity-90"
        >
          <h1
            className="font-hero text-[70px] sm:text-[100px] md:text-[220px] lg:text-[280px] leading-none tracking-tighter font-bold whitespace-nowrap select-none"
            style={{
      ...
      >
        <motion.div
          ...
          className="relative w-[330px] md:w-[450px] lg:w-[500px] h-[420px] md:h-[600px] lg:h-[700px]"
